...
namespace FTSD2.Migrations
{
    ...
    [Migration("20220522130244_LogsAndLogsTypes")]
    partial class LogsAndLogsTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FTSD2.Domain.AmendmentContracts", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double?>("AmendmentCost")
                        .HasColumnType("float");

                    b.Property<DateTime?>("AmendmentLetterApprovalDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("AmendmentPercentage")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ContractorSignutreDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int?>("ModificationDuration")
                        .HasColumnType("int");

                    b.Property<int?>("NewContractActionId")
                        .HasColumnType("int");

                    b.Property<int?>("OptionalPeriodValue")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FTSD2.Domain.Logs", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FTSD2.Domain.LogTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FTSD2.Models.OperationContractsActiveAddViewModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<float?>("OptionalValue")
                        .IsRequired()
                        .HasColumnType("real");
                    ...
                    b.Property<float?>("Uitrate")
                        .IsRequired()
                        .HasColumnType("real");

                    b.HasKey("Id");

                    b.ToTable("OperationContractsActiveAddViewModel");
                });

            modelBuilder.Entity("FTSD2.Models.OperationContractsPreparationAddViewModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OperationContractsPreparationAddViewModel");
                });
            ...
            modelBuilder.Entity("FTSD2.Domain.Logs", b =>
                {
                    b.HasOne("FTSD2.Domain.LogTypes", "LogType")
                        .WithMany("Logs")
